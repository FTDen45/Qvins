...
class widgetMenuBottomMessagesUserChatEvent extends StatelessWidget {
  @override
...
class Comment extends StatelessWidget {
  Comment(
      {this.you,
      this.messeg,
      this.img = 'assets/images/img/avatar_chat_event_message_01.jpg',
      this.friend = 'Мелис Альтаир'});
  bool you;
  String messeg;
  String img;
  String friend;
