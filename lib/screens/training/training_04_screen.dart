...
class TrainingHelp04 extends StatelessWidget {
  const TrainingHelp04({Key key}) : super(key: key);
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/img/screen_training_04.jpg'),
            fit: BoxFit.fill,
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                      'assets/images/img/screen_training_04_center_img.png'),
                  fit: BoxFit.fill,
                ),
              ),
                ...
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                        ...
                        builder: (context) => TrainingHelp05(),
