            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      counterText: "",
                      enabledBorder:
                          widget.showFieldAsBox ? _chooseColorBorder(i) : null,
                      focusedBorder: new UnderlineInputBorder(
                        borderSide: new BorderSide(color: Color(0xffFD4F6A)),
                      ),
                    ),
                    onChanged: (String str) {
                      ...
                      if (_pin.every(
                        ...
                        widget.onSubmit(
                            '${_pin[4]}${_pin[5]}${_pin[6]}${_pin[7]}-${_pin[2]}${_pin[3]}-${_pin[0]}${_pin[1]}');
                      }
                    },
                ...
                Container(
                  ...
                  child: Center(
                    child: Container(
                      width: MediaQuery.of(context).size.width * 0.016, //6,
                      height: MediaQuery.of(context).size.height * 0.001, //1
                      color: Color(0xffFD4F6A),
                    ),
                  ),
                ),
        ...
        : Container(
            ...
            child: TextField(
              ...
              onChanged: (String str) {
                ...
                if (_pin
                    .every((String digit) => digit != null && digit != '')) {
                  widget.onSubmit(
                      '${_pin[4]}${_pin[5]}${_pin[6]}${_pin[7]}-${_pin[2]}${_pin[3]}-${_pin[0]}${_pin[1]}');
                }
              },
